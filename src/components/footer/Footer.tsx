...
export function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-brand-black pt-32 pb-12 border-t border-brand-white/10 overflow-hidden"
    >
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-5xl mb-20 text-center md:text-left">
          <div className="flex flex-col gap-4">
            <h3 className="text-sm tracking-widest uppercase font-semibold text-brand-white mb-2">
              Navigation
            </h3>
            <Link
              href="/about"
